...
<?php include $_SERVER['DOCUMENT_ROOT']."/layout/header.php"; ?>
    ...
    <div id="main">
        <section>
            ...
            <p>예상 키 계산하기 기능은 form태그와 php를 이용하여 <a href="stature.php">stature.php</a>에서 값을 입력하면, <a href="result.php">result.php</a> 파일로 값이 넘어가게끔 구현하였으며, 예외처리도 했습니다. 또한, 회원가입과 로그인 페이지도 같은 기술로 구현하였습니다.</p>
